...
import "@/public/css/scrole.css";
export const Scrole = () => {
  return (
    <section className="bg-white dark:bg-[url(https://i.imgur.com/eZqKEWq.gif)] bg-no-repeat bg-cover medrs">
      <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        ...
        <div className="hidden lg:mt-0 lg:mx-H-4 lg:col-span-5 lg:flex box">
          
        </div>
      </div>

  <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
  <div className="w-full hidden lg:mt-0 lg:mx-H-4 lg:col-span-5 lg:flex box ">
